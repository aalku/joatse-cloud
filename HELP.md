...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/docs/3.0.0-M5/reference/htmlsingle/#appendix.configuration-metadata.annotation-processor)
* [WebSocket](https://docs.spring.io/spring-boot/docs/3.0.0-M5/reference/htmlsingle/#messaging.websockets)
